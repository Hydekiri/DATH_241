...
('Printer D4', 'HL-L2350DW', 'Compact laser printer', 'enable', 4,'9.4kg', 'Laser trắng đen', 0, 0, 1200, 'no', '452x365x352.5 mm','A4, Letter', '600x600 dpi', 'Brother 2345'),
('Printer E5', 'Xerox Phaser', 'High-capacity network printer', 'enable', 5,'9.4kg', 'Laser trắng đen', 0, 0, 1200, 'no', '452x365x352.5 mm','A4, Letter, Legal', '1200x1200 dpi', 'Xerox 6589');
