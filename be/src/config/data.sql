...
-- Bảng `Printer`
INSERT INTO `Printer` (`branchName`, `model`, `description`, `status`, `loc_ID`, `weight`, `printer_type`, `queue`, `prints_in_day`, `pages_printed`, `color_print`, `paper_size`, `resolution`, `ink_type`) VALUES
('Printer A1', 'HP LaserJet', 'High-speed B&W printer', 'enable', 1,'9.4kg', 'Laser trắng đen', 0, 0, 0, 'no', 'A4', '600x600 dpi', 'HP 6520'),
('Printer B2', 'Canon Pixma', 'Color printer with duplex printing', 'enable', 2,'9.4kg', 'Inkjet màu', 0, 0, 0, 'yes', 'A4, A5', '1200x1200 dpi', 'Canon 9523'),
('Printer C3', 'Epson EcoTank', 'Eco-friendly color printer', 'disable', 3,'9.4kg', 'Inkjet màu', 0, 0, 0, 'yes', 'A4, Legal', '1440x1440 dpi', 'Epson Eco 500'),
('Printer D4', 'Brother HL-L2350DW', 'Compact laser printer', 'enable', 4,'9.4kg', 'Laser trắng đen', 0, 0, 0, 'no', 'A4, Letter', '600x600 dpi', 'Brother 2345'),
('Printer E5', 'Xerox Phaser', 'High-capacity network printer', 'enable', 5,'9.4kg', 'Laser trắng đen', 0, 0, 0, 'no', 'A4, Letter, Legal', '1200x1200 dpi', 'Xerox 6589');
